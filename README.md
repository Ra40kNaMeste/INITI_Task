# Описание
Это выполненное тестовое задание в одну компанию. В нём необходимо было реализовать серилиализатор и десериализатор для некоторого протокола. Основная сложность: запрет на создание объектов в куче и запрет на виртуальные функции 
